...
public class RUDPSender {
	...
	// sender constructor
	public RUDPSender(int sk1_dst_port, int sk4_dst_port, String path, String fileName) {
		base = 0;
		nextSeqNum = 0;
		this.path = path;
	...
	public static void main(String[] args) {
		...
		else new RUDPSender(Integer.parseInt(args[0]), Integer.parseInt(args[1]), args[2], args[3]);
	}
}